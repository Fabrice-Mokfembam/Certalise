  ...
  if (error)
    return (
      <div className='text-red-600'>
        Error loading certificate: {(error as Error).message}
      </div>
    );
      ...
      <section className='bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8'>
        <div className='border-b border-gray-200 p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <InfoField
              label='Date of Birth'
              value={new Date(certificate.dob).toLocaleDateString()}
            />
            <InfoField
              label='Place of Birth'
              value={certificate.placeOfBirth}
            />
          </div>
        </div>
        ...
        <div className='border-b border-gray-200 p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <InfoField
              label='Date of Birth'
              value={
                certificate.fatherDob
                  ? new Date(certificate.fatherDob).toLocaleDateString()
                  : "N/A"
              }
            />
            <InfoField
              label='Place of Birth'
              value={certificate.fatherPlaceOfBirth || "N/A"}
            />
            <InfoField
              label='Residence'
              value={certificate.fatherResidence || "N/A"}
            />
            <InfoField
              label='Occupation'
              value={certificate.fatherOccupation || "N/A"}
            />
            <InfoField
              label='Nationality'
              value={certificate.fatherNationality || "N/A"}
            />
            <InfoField
              label='Reference Document'
              value={certificate.fatherReferenceDocument || "N/A"}
            />
          </div>
        </div>
        ...
        <div className='border-b border-gray-200 p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <InfoField
              label='Date of Birth'
              value={
                certificate.motherDob
                  ? new Date(certificate.motherDob).toLocaleDateString()
                  : "N/A"
              }
            />
            <InfoField
              label='Place of Birth'
              value={certificate.motherPlaceOfBirth || "N/A"}
            />
            <InfoField
              label='Residence'
              value={certificate.motherResidence || "N/A"}
            />
            <InfoField
              label='Occupation'
              value={certificate.motherOccupation || "N/A"}
            />
            <InfoField
              label='Nationality'
              value={certificate.motherNationality || "N/A"}
            />
            <InfoField
              label='Reference Document'
              value={certificate.motherReferenceDocument || "N/A"}
            />
          </div>
        </div>
        ...
        <div className='p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <InfoField
              label='Date Drawn'
              value={new Date(certificate.dateDrawn).toLocaleDateString()}
            />
      ...
      <section className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8'>
        <div className='flex items-center justify-between mb-4'>
          ...
          <button
            ...
            className='text-[#2196F3] hover:text-[#2196F3]/80'
          >
            {showPreview ? (
              <>
